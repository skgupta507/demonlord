...
const Dots = () => (
  <rect x="0" y="0" width="4" height="4" className="text-muted-foreground" fill="currentColor" />
);
...
export const Pattern = ({ variant }: PatternProps) => {
  ...
  return (
    <>
      ...
      >
        <defs>
          <pattern id={variant} x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
            {pattern[variant]()}
          </pattern>
        </defs>
