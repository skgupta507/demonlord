      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <ul>
            <li>
              <a
                href="https://erynith.github.io/movie-web-instances/"
            ...
            <li className="mb-2">
              <a
                href="https://cse.google.com/cse?cx=006516753008110874046:cfdhwy9o57g##gsc.tab=0"
                className="text-blue-500 hover:underline"
              >
                Streaming CSE
              </a>{' '}
            ...
            <li className="mb-2">
              <a
                href="https://www.downloads-anymovies.co/"
                className="text-blue-500 hover:underline"
              >
                Downloads-Anymovies
              </a>{' '}
            ...
            <li className="mb-2">
              <a
                href="https://greasyfork.org/en/scripts/407284-imdb-scout-mod"
                className="text-blue-500 hover:underline"
              >
                IMDb Scout
              </a>{' '}
