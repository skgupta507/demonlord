            ...
            <div className="border border-white/8 p-4 space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-1.5 min-w-0">
                  ...
                  {studio && (
                    <p className="text-[0.55rem] text-white/30" style={{ fontFamily: 'Share Tech Mono, monospace' }}>
                      {studio}
                    </p>
                  )}
                </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div key={s.label} className="border border-white/8 p-2.5 space-y-1">
                  <p className="text-[0.48rem] tracking-widest text-white/25 uppercase" style={{ fontFamily: 'Share Tech Mono, monospace' }}>{s.label}</p>
                  <p className="text-sm font-bold text-white/70" style={{ fontFamily: 'Share Tech Mono, monospace' }}>{s.value}</p>
                </div>
              ))}
            </div>
          </aside>
